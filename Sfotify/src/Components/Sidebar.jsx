  ...
  return (
    <div className=' w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex '>
        <div className='bg-[#121212] h-[15%] rounded flex flex-col  justify-around'>
            <div onClick={()=>navigate('./')} className='flex item-center gap-3 pl-8 cursor-default'>
                <img className='w-6' src={assets.home_icon}/>
                <p className='font-bold'>Home</p>

            </div>
            <div className='flex item-center gap-3 pl-8 cursor-default'>
            ...
            <div className='bg-[#121212] h-[85%] rounded'>
                ...
                <div className='p-4 bg-[#2424242] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1  pl-4'>
